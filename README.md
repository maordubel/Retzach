...
- **"תיק פתוח" · משחק הארכיון** — שני שאלונים אינטראקטיביים: *"איזה רוצח סדרתי אתה?"*
  ו*"על ידי מי היית נרצח?"*. המנוע **גוזר פרופיל מכל תיק לבד** מהטקסט ומהנתונים,
  ולכן **תיק חדש מצטרף למשחק ברגע שהוא נכנס למאגר** — בלי לגעת בקוד המשחק
...
├── assets/quiz.js             "תיק פתוח" — משחק הארכיון (נטען רק בלחיצה)
